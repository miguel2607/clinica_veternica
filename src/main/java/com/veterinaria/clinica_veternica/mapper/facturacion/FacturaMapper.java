...
public interface FacturaMapper {
    ...
    @Mapping(target = "estaVencida", expression = "java(factura.estaVencida())")
    @Mapping(target = "diasVencimiento", expression = "java(factura.getDiasVencimiento())")
